...
public class ES2UserType_NewButton : ES2Type
{
	public override void Write(object obj, ES2Writer writer)
	{
		NewButton data = (NewButton)obj;
...
writer.Write(data.hideFlags);
	...
	{
		NewButton data = GetOrCreate<NewButton>();
		Read(reader, data);
		return data;
	}
...
data.hideFlags = reader.Read<UnityEngine.HideFlags>();
	...
	public ES2UserType_NewButton():base(typeof(NewButton)){}
}