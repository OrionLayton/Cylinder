...
public class ES2UserType_BoundsCheck : ES2Type
{
	public override void Write(object obj, ES2Writer writer)
	{
		BoundsCheck data = (BoundsCheck)obj;
...
writer.Write(data.hideFlags);
	...
	{
		BoundsCheck data = GetOrCreate<BoundsCheck>();
		Read(reader, data);
		return data;
	}
	...
	{
		BoundsCheck data = (BoundsCheck)c;
...
data.hideFlags = reader.Read<UnityEngine.HideFlags>();
	...
	public ES2UserType_BoundsCheck():base(typeof(BoundsCheck)){}
}