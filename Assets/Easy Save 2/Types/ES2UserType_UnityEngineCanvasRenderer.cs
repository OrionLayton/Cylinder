...
writer.Write(data.hasPopInstruction);
writer.Write(data.materialCount);
writer.Write(data.popMaterialCount);
writer.Write(data.cull);
...
data.hasPopInstruction = reader.Read<System.Boolean>();
data.materialCount = reader.Read<System.Int32>();
data.popMaterialCount = reader.Read<System.Int32>();
data.cull = reader.Read<System.Boolean>();
